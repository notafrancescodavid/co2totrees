...
export default function Home() {
  ...
  const serviceExplanationSubTitle = "Imagine every year you plant some trees. The trees you plant each year absorb more and more Co2 as they grow. Use the calculator to see, depending on how many trees you imagine to plant each year, how much time you would need to become Carbon Negative.";
